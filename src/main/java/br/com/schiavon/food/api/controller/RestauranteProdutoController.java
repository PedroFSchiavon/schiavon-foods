...
public class RestauranteProdutoController {
    ...
    @GetMapping
    public List<ProdutoDTO> listar(@PathVariable Long idRestaurante, @RequestParam(required = false) boolean inativo){
        List<Produto> produtos = produtoService.listarProduto(idRestaurante, inativo);
